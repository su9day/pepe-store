...
const fontStyle = async () => {
	try {
	  // Проверяем существование файла scss/config/fonts.scss
	  if (fs.existsSync(fontFacesFile)) {
		logger.warning('Файл scss/config/fonts.scss уже существует.\nДля обновления файла его нужно удалить!');
		return;
	  }
  
	  // Получаем список файлов в папке с конвертированными шрифтами
	  ...
	  // Создаем или очищаем файл scss/config/fonts.scss
